...
const company = 'The Pokémon Company International, Inc.'
...
<template>
  ...
  <div class="flex flex-col items-center gap-4 text-sm text-center text-(--ui-bg) p-4 text-base-200 bg-gradient-to-r"
